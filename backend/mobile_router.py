...
#     # Also update outlet devices' valve_state so _process_outlet_reading
#     # always reads the correct valve state for the leak service.
#     outlet_result = await db.execute(
#         select(Device)
#         .where(
#             Device.zone_id     == body.zone_id,
...
#         )
#     )
#     outlet_devices = outlet_result.scalars().all()
#     for outlet_device in outlet_devices:
#         outlet_device.valve_state = body.action
