...
// Hardware Pins
#define SENSOR1 25    // Inlet YF-S201
#define SENSOR2 26    // Outlet YF-S201
#define RELAY 5       // Solenoid valve control (inlet line)
...
void setup() {
  ...
  digitalWrite(RELAY, LOW); // Valve open by default
...
void loop() {
  ...
  if (flowRate2 < flowRate1 && flowRate2 < 8) {
    ...
    digitalWrite(RELAY, HIGH);  // Close solenoid valve (cut inlet water)
