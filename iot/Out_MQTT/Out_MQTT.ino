...
const char* mqtt_server = "66791e6741b44aecb122ab7b59807177.s1.eu.hivemq.cloud";  // Replace with your HiveMQ cluster URL
const char* mqtt_username = "AquaSense";                   // Replace with your HiveMQ username
const char* mqtt_password = "Aquasense@123@#";                   // Replace with your HiveMQ password
